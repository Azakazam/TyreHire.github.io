...
<div class="newHead">
			<h2><i class="fa fa-car" style="font-size:36px;"></i>&nbsp;Welcome to TyreHire</h2>
	...
	<div class="col-sm-6">
			...
			<h3> Our Agency </h3>
<p>Whilst many driving recruitment agencies claim to be 'different,' Tyre Hire have firmly established themselves as experts in only supplying professional drivers that match the client requirements. This refreshing approach means that as a client you are guaranteed to receive the service you are looking for. </p>
			<img class="newrecruit img-responsive" src="images/recruit.jpg" alt="recruitment">
			<br />
			<ul>
			<li>Need a driver that can do night work? </li>
			<li>Need a driver that has a class 2 license?</li>
			<li>Need a driver that has at least 3 years experience? </li>
			</ul>
		<p> Well this site is the best place to fullfill your requests. </p>
		...
		<div class="col-sm-6">
			<div class="right">
					...
					<h3> About driving agencies </h3>
					<img class="newrecruit img-responsive" src="images/truckdriver.jpg" alt="driver">
	<p>There are many employment opportunities available in the Driving Sector, and recruitment agencies are keen to find new drivers to fill spaces left behind by the substantial number of recent retirees. The sector is also expected to expand its workforce significantly in the coming years as environmental concerns result in the increasing importance of public transport. </p>
	<p>Well thats what this site is all about!</p>
			<p>Use our helpful search function to get started and look for the most suitable driver to fill your role.</p>
